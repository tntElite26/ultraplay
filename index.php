	...
	<div class="container">
		...
		<form id="action-form" action="action.php" method="POST" accept-charset="utf-8">
			...
			<div class="form-group">
			    <br>
				<label class="font-weight-bold">LINK Direct Archive:</label>
				<input type="text" name="link" class="form-control" placeholder="Ex: https://archive.org/download/digimon-21/Digimon%2021.mp4"this.select()" required>
			</div>
		...
		<label class="font-weight-bold">Example link Archive: https://archive.org/details/digimon-21 </label>
		<label class="font-weight-bold">Example link Archive JWPlayer: https://archive.org/download/digimon-21/Digimon%2021.mp4 </label>
	</div><!-- /.container -->
	<?php
	}
